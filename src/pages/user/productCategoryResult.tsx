...
import { getProductsByCategory } from "../../API/apiGetProductDetail";
...
const ProductCategoryResult: React.FC<any> = () => {
    ...
    return (
        <div className="contentContainer">
            <h2>-- SẢN PHẨM THUỘC {categoryName?.toUpperCase()} --</h2>
            {loading ? (
                <p>Đang tải...</p>
            ) : (
                <div className="product-grid">
                    {products.length > 0 ? (
                        ...
                        <p><strong>Không có sản phẩm nào thuộc danh mục này.</strong></p>
                    )}
                </div>
            )}
